...
PKGDATA = {'pylogeny':['fitch.cpp','fitch.so','pylibpll.c','pylibpll.so']}

setup(name='pylogeny',version=VERSION,description=DESCRIP,long_description=LONG,url=URL,author=AUTHOR,author_email=EMAIL,license='MIT',packages=['pylogeny'],package_data=PKGDATA,install_requires=DEPNDS,dependency_links=LINKS,zip_safe=False)
